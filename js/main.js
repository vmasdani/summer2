...
var $author$project$Main$init = F3(
	function (flags, url, key) {
		return _Utils_Tuple2(
			{
				bomItems: $elm$core$Maybe$Just(_List_Nil),
				bomSearch: '',
				bomUuidToDelete: '',
				boms: $elm$core$Maybe$Just(_List_Nil),
				currentSeed: $elm$random$Random$initialSeed(flags.seed),
				key: key,
				modalContent: A2($elm$html$Html$div, _List_Nil, _List_Nil),
				seed: flags.seed,
...
var $author$project$Main$idbRecv = _Platform_incomingPort(
	'idbRecv',
	A2(
...
var $author$project$Main$subscriptions = function (_v0) {
	return $elm$core$Platform$Sub$batch(
		_List_fromArray(
			[
				$author$project$Main$idbRecv($author$project$Main$Recv)
			]));
};
var $author$project$Main$DeleteBom = function (a) {
	return {$: 'DeleteBom', a: a};
};
var $author$project$Main$ToggleModal = {$: 'ToggleModal'};
var $author$project$Main$Bom = F2(
	function (uuid, name) {
...
var $author$project$Main$bomDecoder = A3(
	...
	A3(
		...
		'uuid',
		$elm$json$Json$Decode$maybe($elm$json$Json$Decode$string),
		$elm$json$Json$Decode$succeed($author$project$Main$Bom)));
...
var $author$project$Main$bomEncoder = function (bom) {
	return $elm$json$Json$Encode$object(
		_List_fromArray(
			[
				_Utils_Tuple2(
				'uuid',
				A2($elm_community$json_extra$Json$Encode$Extra$maybe, $elm$json$Json$Encode$string, bom.uuid)),
				_Utils_Tuple2(
				'name',
				A2($elm_community$json_extra$Json$Encode$Extra$maybe, $elm$json$Json$Encode$string, bom.name))
			]));
};
...
var $author$project$Main$idbSend = _Platform_outgoingPort(
	'idbSend',
	function ($) {
		return $elm$json$Json$Encode$object(
			_List_fromArray(
...
var $author$project$Main$update = F2(
	function (msg, model) {
		switch (msg.$) {
													...
													[
														...
														'Really delete BoM ' + (function () {
															...
															if (_v2.$ === 'Just') {
																...
																if (_v3.$ === 'Just') {
																	var foundBom = _v3.a;
																	return A2($elm$core$Maybe$withDefault, '', foundBom.name);
																} else {
																	return '';
																}
															} else {
													...
													[
														...
														_List_fromArray(
															[
																...
																$author$project$Main$DeleteBom(bomUuid))
															]),
														_List_fromArray(
															[
			...
			case 'AddBom':
				var _v4 = A2($elm$random$Random$step, $danyx23$elm_uuid$Uuid$uuidGenerator, model.currentSeed);
				var newUuid = _v4.a;
				var newSeed = _v4.b;
				var newBom = {
					name: $elm$core$Maybe$Just(''),
					uuid: $elm$core$Maybe$Just(
...
var $author$project$Main$SearchBom = function (a) {
	return {$: 'SearchBom', a: a};
};
var $author$project$Main$SetModel = function (a) {
	return {$: 'SetModel', a: a};
};
var $author$project$Main$ShowBomUuidDeleteModal = function (a) {
	return {$: 'ShowBomUuidDeleteModal', a: a};
};
	...
	return {
		body: _List_fromArray(
			[
				...
				_List_fromArray(
					[
						$elm$html$Html$Attributes$class('container mx-auto my-3')
					]),
				_List_fromArray(
					[
						A2(
						...
						_List_fromArray(
							[
								...
								_List_fromArray(
									[
										$elm$html$Html$Attributes$class('border-4 border-green-800 bg-green-600 font-bold text-white text-xl rounded-lg shadow shadow-lg p-4')
									]),
								_List_fromArray(
									[
										$elm$html$Html$text('Summer')
									]))
							])),
						A2(
						$elm$html$Html$div,
						_List_fromArray(
							[
								$elm$html$Html$Attributes$class('flex justify-center my-2')
							]),
						_List_fromArray(
							[
								A2(
								...
								_List_fromArray(
									[
										$elm$html$Html$text('Your simple BoM List Manager')
									]))
							])),
						A2(
						$elm$html$Html$hr,
						_List_fromArray(
							[
								$elm$html$Html$Attributes$class('my-2 border-2 border-gray-400')
							]),
						_List_Nil),
						A2(
						$elm$html$Html$div,
						...
						_List_fromArray(
							[
								...
								_List_fromArray(
									[
										$elm$html$Html$text(
										$elm$core$String$fromInt(model.seed))
									])),
								A2(
								$elm$html$Html$div,
								_List_Nil,
								_List_fromArray(
									[
										...
										$elm$core$Debug$toString(
											A2($elm$random$Random$step, $danyx23$elm_uuid$Uuid$uuidGenerator, model.currentSeed)))
									])),
								A2(
								$elm$html$Html$button,
								_List_fromArray(
									[
										$elm$html$Html$Attributes$class('px-2 py-2 font-bold text-white bg-blue-500 hover:bg-blue-700'),
										$elm$html$Html$Events$onClick(
								...
								_List_fromArray(
									[
										$elm$html$Html$Attributes$class('px-2 py-2 font-bold text-white bg-green-500 hover:bg-green-700'),
										$elm$html$Html$Events$onClick($author$project$Main$AddBom)
									]),
								_List_fromArray(
									[
										$elm$html$Html$text('Add BoM')
									])),
								A2(
								$elm$html$Html$div,
								_List_fromArray(
									[
										$elm$html$Html$Attributes$class('flex my-3')
									]),
								_List_fromArray(
									[
										A2(
										...
										_List_fromArray(
											[
												$elm$html$Html$Attributes$class('flex-grow border-2 border-gray-500 rounded-md px-2 py-1'),
												$elm$html$Html$Attributes$placeholder('Search BoM...'),
												$elm$html$Html$Events$onInput($author$project$Main$SearchBom)
											]),
										_List_Nil)
									])),
								function () {
																...
																[
																	...
																	_List_fromArray(
																		[
																			...
																			$elm$html$Html$Events$onClick(
																			$author$project$Main$ShowBomUuidDeleteModal(
																				A2($elm$core$Maybe$withDefault, '', bom.uuid)))
																		]),
																	_List_fromArray(
																		[
																			A2(
						...
						A2($author$project$Modal$modal, model.showModal, model.modalContent)
					]))
			]),
